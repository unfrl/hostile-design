...
const links = [{ to: "/information", title: "Information" }];
...
class _MainLayout extends React.Component<any, any> {
  ...
  private renderLogo = () => {
    ...
    return (
      <Link to="/" className={classes.home}>
        <img src={logo} alt="Hostile.Design" className={classes.logo} />
  ...
  private renderLinks = (drawerNav: boolean = false) => {
    const { classes } = this.props;
    const linkTitle = `${classes.linkTitle} ${
      drawerNav ? classes.drawerLinkTitle : ""
    }`;
